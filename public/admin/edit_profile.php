    ...
    <section>
        <div class="section">
            ...
            <div class="row container">
                <?php $admin = find_by_id('users', $_SESSION['user_id']); ?>
                        ...
                        <div class="card" style="overflow: visible">
                            <div class="card-image">
                                <img class="preview materialboxed"
                                     src="../images/user/<?= get_user_image($admin['id']) ?>"
                                ...
                                <div class="col s10 offset-s1 l8 offset-l2">
                                    ...
                                    <div class="input-field">
                                        <input type="text" id="first_name" name="first_name"
                                               ...
                                               value="<?= isset($_POST['modify']) ? $_POST['first_name'] : $admin['first_name'] ?>">
                                    ...
                                    <div class="input-field">
                                        <input type="text" id="last_name" name="last_name"
                                               ...
                                               value="<?= isset($_POST['modify']) ? $_POST['last_name'] : $admin['last_name'] ?>">
                                    ...
                                    <div class="input-field country">
                                        <select id="country" name="country">
                                            ...
                                            foreach ($WORLD_COUNTRIES as $country)
                                                echo isset($_POST['country']) && $_POST['country'] == htmlentities($country, ENT_QUOTES) || !isset($_POST['country']) && htmlentities($country, ENT_QUOTES) == $admin['country'] ?
                                    ...
                                    <div class="input-field">
                                        <input type="text" id="username" name="username"
                                               ...
                                               value="<?= isset($_POST['register']) ? $_POST['username'] : $admin['username'] ?>">
                                    ...
                                    <div class="input-field">
                                        <input type="email" id="email" name="email" class="validate"
                                               ...
                                               value="<?= isset($_POST['register']) ? $_POST['email'] : $admin['email'] ?>">
