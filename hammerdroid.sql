...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2015 at 05:16 PM
...
CREATE TABLE IF NOT EXISTS `buildings` (
  ...
  `name_srb` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `name_hun` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `name_eng` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `buildings` (`id`, `id_groups`, `name_srb`, `name_hun`, `name_eng`) VALUES
(1, 1, 'Hidroelektrane', NULL, NULL),
(2, 1, 'Termoelektrane', NULL, NULL),
(3, 1, 'Nuklearne elektrane', NULL, NULL),
(4, 2, 'Skola', 'Iskola', 'School'),
(5, 2, 'Bolnica', 'Korház', 'Hospital'),
...
(41, 4, 'Drumski mostovi bez saobraćaja', NULL, NULL),
...
INSERT INTO `cities` (`id`, `id_countries`, `name_srb`, `name_hun`, `name_eng`, `altitude`, `wind_force`) VALUES
(1, 1, 'Ajdovscina', NULL, NULL, 110, 35),
(2, 1, 'Maribor', 'Maribor', 'Maribor', 275, 19),
(3, 4, 'Subotica', 'Szabadka', 'Subotica', 123, 45),
(4, 4, 'Novi sad', 'Újvidék', 'Novi sad', 156, 52),
(6, 4, 'Kanjiža', 'Kanizsa', 'Kanjiza', 100, 123);
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `image` varchar(19) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `data` (`id`, `id_dimensions`, `S`, `A`, `Wx`, `Wy`, `Ix`, `Iy`, `Jx`, `Jy`) VALUES
...
CREATE TABLE IF NOT EXISTS `groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name_srb` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `name_hun` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `groups` (`id`, `name_srb`, `name_hun`, `name_eng`) VALUES
...
ALTER TABLE `buildings`
  ADD CONSTRAINT `buildings_ibfk_1` FOREIGN KEY (`id_groups`) REFERENCES `groups` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `cities`
--
ALTER TABLE `cities`
  ADD CONSTRAINT `cities_ibfk_1` FOREIGN KEY (`id_countries`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `factors`
  ADD CONSTRAINT `factors_ibfk_1` FOREIGN KEY (`id_buildings`) REFERENCES `buildings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
